...
async def websocket_endpoint(websocket: WebSocket) -> None: 
    ...
    try:
        ...
        while True:
            ...
            async_functions = ["chat", "summarize", "summarize_article", "summarize_file", "test_tag_idea", "verify_summary"] # Unfortunately some of the functions need to be handled differently. This is a temporary solution and will be refactored.
